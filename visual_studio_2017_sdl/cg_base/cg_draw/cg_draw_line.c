...
static void draw_line_hor(draw_line_t* line, cg_area_t* mask, cg_style_t* style, cg_alpha_t alpha);
static void draw_line_ver(draw_line_t* line, cg_area_t* mask, cg_style_t* style, cg_alpha_t alpha);
static void draw_line_slash(draw_line_t* line, cg_style_t* style);
static void draw_line_bresenham(cg_point_t* ps, cg_point_t* pe, cg_area_t* mask, cg_style_t* style, cg_alpha_t alpha);

/************************************************************************/
/* global functions                                                     */
/************************************************************************/
void cg_draw_ground_line(cg_point_t* ps, cg_point_t* pe, cg_area_t* mask, cg_style_t* style, cg_alpha_t alpha)
{
    if(0 == style->line.wdith)return;
    if(ps->x == pe->x && ps->y == pe->y)return;

    draw_line_bresenham(ps, pe, mask, style, alpha);
...
//void draw_line_ver(draw_line_t* line, cg_area_t* mask, cg_style_t* style, cg_alpha_t alpha)
//{
...
//}
//
//void draw_line_hor(draw_line_t* line, cg_area_t* mask, cg_style_t* style, cg_alpha_t alpha)
//{
//    cg_ruler_t  width_half = style->line.wdith >> 1;
//    cg_ruler_t  width_last = style->line.wdith & 0b1;
//
...
//}
//
//static void draw_line_slash(draw_line_t* line, cg_area_t* mask, cg_style_t* style, cg_alpha_t alpha)
//{
//    double dx, dy, f;
